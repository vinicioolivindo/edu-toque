...
const API_URL = 'http://192.168.0.108:3000/upload';
    ...
    return (
        <SafeAreaView className="flex-1 bg-white">
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1">
                ...
                <TouchableOpacity onPress={() => router.push('/feed')} className='flex-1 w-24 h-24 absolute right-4 bottom-28 flex flex-col items-center justify-center rounded-full shadow-black shadow-2xl bg-slate-100'>
                    <Logo />
                    <Text className='text-2xl font-extrabold text-secondaryColor'>Play</Text>
                </TouchableOpacity>
