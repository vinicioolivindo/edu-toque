...
function CentralTabButton({ onPress, accessibilityState, style }) {
  ...
  return (
    <Pressable
      ...
      // Importante: herdar o `style` que o React Navigation passa (tem flex: 1),
      // senão o botão não estica/centraliza igual aos outros itens da barra.
      style={[
        style,
        {
          alignItems: 'center',
    ...
    >
      <View
        style={{
          ...
          justifyContent: 'center',
          transform: [
            { translateY: -34 }, // flutua acima da tab bar
      ...
      >
        <Svg width={64} height={66} viewBox="0 0 91 94">
          ...
          <Path d={PLAY_PATH} fill={playColor} />
        </Svg>
      </View>
    </Pressable>
  );
